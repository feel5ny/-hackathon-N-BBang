  ...
  function insertListTable({
    ...
    <div class="insertCard" id="${id}">
      <div class="cardHeader">
        <p>${day}</p>
        <img src="/src/img/trash.svg" class="deleteBtn" data-id="${id}">
    ...
    <div class="cardBody">
      <div class="col-8 cardBodyLeft">
        ...
        <div class="moneyCal">
          ...
          <div class="getMoney"> <label>받은 돈</label> <p class="rightMoney">-</p><p class="rightGetMoney"> 0 </p></div>
          <div class="leftMoney"> <label>남은 돈</label><img src="src/img/coin_one.svg"><p class="rightLeftMoney"> ${myMoney} </p></div>
        </div>
      </div>
    <div class="col-8 cardBodyRight grey">
        <div>
    ...
    [...checkArray].map(el => {
      ...
      el.onchange = function(){
        ...
        if(el.checked === true){   
          ...
          byName.style.color = 'grey';
        } else {
          total -= money;
          byName.style.textDecoration = 'none';
          byName.style.color = 'black';
        }
